          ...
          {variant === "compressor" && (
            <>
              ...
              <p className="text-amber-100/90 mt-2 text-xs border-t border-amber-500/30 pt-2">
                If you design in Canva (or similar) and export PDF, that PDF is your interior — use our <Link href="/kdp-pdf-checker" className="underline font-medium text-amber-200 hover:text-amber-100">Print Ready Check</Link> to verify. If you write in Word, use KDP Formatter (DOCX) to generate your print PDF.
              </p>
            </>
          )}
          {variant === "optimizer" && (
