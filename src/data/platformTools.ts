...
export const PLATFORMS: Platform[] = [
  { id: "kdp", name: "Amazon KDP", tagline: "Everything you need for Amazon KDP", toolIds: ["pdf-compress", "pdf-optimizer", "royalty-calculator", "page-count-estimator", "trim-size-comparison", "spine-calculator", "cover-calculator", "interior-template", "banned-keyword-checker", "kids-trim-guide", "kdp-formatter", "keyword-research", "description-generator", "kdp-pdf-checker", "kdp-format-review", "keyword-research-pdf", "description-generator-pdf", "epub-maker"] },
];
