...
export const ALL_TOOLS: Tool[] = [
  ...
  { id: "kdp-pdf-checker", title: "KDP Preflight (PDF Checker)", description: "Full PDF validation: 26 KDP rules, trim, margins, bleed, images. Pass/fail report + on-page highlights.", href: "/kdp-pdf-checker", available: true, iconPath: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4", pricing: PAID_PRICING },
