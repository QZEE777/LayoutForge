...
export interface Tool {
  ...
  pricing?: string;
  /** Show "Coming soon" badge; card still visible but not primary CTA. */
  comingSoon?: boolean;
}
...
export const ALL_TOOLS: Tool[] = [
  ...
  { id: "keyword-research", title: "7 Keyword Research (DOCX)", description: "Get 7 KDP keyword phrases from your DOCX manuscript.", href: "/keyword-research", available: true, iconPath: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7", pricing: PAID_PRICING, comingSoon: true },
  ...
  { id: "pdf-compress", title: "PDF Compressor", description: "Shrink or print-optimize PDFs up to 50MB in your browser. No upload.", href: "/pdf-compress", available: true, iconPath: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4 4m0 0l-4-4m4 4V4", free: true },
  ...
  { id: "kids-trim-guide", title: "Kids book trim guide", description: "Trim sizes and page counts for picture books and children's titles.", href: "/kids-trim-guide", available: false, iconPath: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253", free: true, comingSoon: true },
  { id: "journals-coloring-puzzle-guide", title: "Journals, coloring & puzzle guide", description: "Trim sizes, page counts, and KDP tips for journals, workbooks, coloring books, and puzzle/activity books.", href: "/journals-coloring-puzzle-guide", available: false, iconPath: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z", free: true, comingSoon: true },
];
...
export const PLATFORMS: Platform[] = [
  { id: "kdp", name: "Amazon KDP", tagline: "Everything you need for Amazon KDP", toolIds: ["pdf-compress", "royalty-calculator", "page-count-estimator", "trim-size-comparison", "spine-calculator", "cover-calculator", "interior-template", "banned-keyword-checker", "kdp-pdf-checker"] },
];
