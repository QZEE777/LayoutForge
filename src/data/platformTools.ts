...
export const ALL_TOOLS: Tool[] = [
  ...
  { id: "kdp-format-review", title: "KDP Format Review", description: "AI format review: KDP Readiness + top fixes. Paste or upload DOCX/PDF.", href: "/kdp-format-review", available: true, iconPath: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", pricing: PAID_PRICING, comingSoon: true },
