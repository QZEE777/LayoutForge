    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-lg">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Kindle EPUB Maker</h1>
          <p className="text-lg text-slate-400 leading-relaxed mb-10">
            Convert your manuscript to a Kindle-ready EPUB file. Proper chapter structure, metadata, and formatting for eBook distribution on Amazon KDP.
          </p>
          <Link
            href="/"
