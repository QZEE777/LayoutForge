    ...
    <SiteShell>
      <section className="bg-[#FAF7EE] py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="prose prose-sm max-w-none space-y-8 [&_h2]:text-[#1A1208] [&_p]:text-[#6B6151] [&_a]:text-[#F05A28] [&_a]:hover:underline" style={{ fontFamily: "Inter, sans-serif" }}>
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">1. Acceptance</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">2. Services</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">3. Account and use</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">4. Payment and subscriptions</h2>
            <p className="text-[#6B6151]">
              Payments for paid tools and bundles are processed by Lemon Squeezy (“Merchant”). Their terms and payment policies apply to transactions. Refunds are handled in accordance with our <Link href="/refunds" className="text-[#F05A28] hover:underline">Refund Policy</Link> and the Merchant’s policy. By purchasing, you agree to the Merchant’s terms and our refund terms.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">5. No guarantee of platform approval</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">6. Acceptable use</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">7. Intellectual property</h2>
            <p className="text-[#6B6151]">
              We own or license the manu2print brand, website, and tool software. You retain ownership of content you upload. By using our Services, you grant us a limited license to process your content only as necessary to provide the Services (e.g. formatting, analysis). We do not use your content for training AI models or for marketing without your consent, as described in our <Link href="/privacy" className="text-[#F05A28] hover:underline">Privacy Policy</Link>.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">8. Disclaimers</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">9. Limitation of liability</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">10. Refunds</h2>
            <p className="text-[#6B6151]">
              Refund eligibility and process are set out in our <Link href="/refunds" className="text-[#F05A28] hover:underline">Refund Policy</Link>. Requests are handled in line with that policy and the Merchant’s procedures.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">11. Termination</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">12. Changes to terms</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">13. Governing law</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#1A1208] mt-6 mb-2">14. Contact</h2>
            <p className="text-[#6B6151]">
              For questions about these Terms, contact us at <Link href="/contact" className="text-[#F05A28] hover:underline">Contact</Link> or the email address listed there.
            </p>
          </section>
          </div>
        </div>
