...
const docxTools: Tool[] = [
  ...
  { id: "description-generator", title: "Amazon Description Generator (DOCX)", description: "AI book description, bio template, keywords, BISAC from DOCX.", href: "/description-generator", available: true, iconPath: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
];
...
const pdfTools: Tool[] = [
  ...
  { id: "description-generator-pdf", title: "Amazon Description Generator (PDF)", description: "AI book description, bio template, keywords, BISAC from PDF.", href: "/description-generator-pdf", available: true, iconPath: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
];
