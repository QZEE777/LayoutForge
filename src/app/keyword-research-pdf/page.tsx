    ...
    <div className="min-h-screen bg-m2p-ivory flex flex-col">
      ...
      <div className="border-b border-m2p-border bg-m2p-orange-soft">
        <div className="mx-auto max-w-4xl px-6 py-3 flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-m2p-ink">7 Keyword Research (PDF)</span>
          <span className="mx-2 text-m2p-muted">|</span>
          <span className="text-sm text-m2p-muted">7 KDP keyword phrases from your PDF</span>
        </div>
      </div>
      ...
      <main className="flex-1 mx-auto max-w-3xl w-full px-6 py-10">
        ...
        <h1 className="text-3xl font-bold text-m2p-ink mb-2">7 Keyword Research (PDF)</h1>
        ...
        {keywords && keywords.length > 0 && (
          <div className="rounded-2xl bg-m2p-orange-soft/50 border border-m2p-border p-6 mt-8">
            <h2 className="text-lg font-bold text-m2p-ink mb-3">7 Amazon KDP keyword phrases</h2>
