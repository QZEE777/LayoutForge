    ...
    <div className="min-h-screen bg-m2p-ivory flex flex-col">
      ...
      <div className="border-b border-m2p-border bg-m2p-orange-soft">
        <div className="mx-auto max-w-4xl px-6 py-3 flex items-center gap-3">
          ...
          <span className="text-sm text-m2p-muted">Description, author bio, SEO & BISAC from PDF</span>
        </div>
      </div>
      ...
      <main className="flex-1 mx-auto max-w-3xl w-full px-6 py-10">
        ...
        <div className="rounded-2xl bg-m2p-orange-soft/50 border border-m2p-border p-6 mb-8">
          <label className="block text-sm font-medium text-m2p-ink mb-2">Manuscript file (PDF only, max {MAX_MB}MB)</label>
          <input
            type="file"
            accept=".pdf,application/pdf"
            onChange={handleFileChange}
            className="block w-full text-sm text-m2p-ink file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-red-600 file:text-white file:font-medium file:hover:bg-red-700"
          />
          {file && (
            <div className="mt-2">
          ...
          {loading && progress > 0 && (
            <div className="mt-4">
              ...
              <div className="h-2 rounded-full bg-m2p-orange-soft overflow-hidden">
        ...
        {result && (
          <div className="space-y-8">
            <div className="rounded-2xl bg-m2p-orange-soft/50 border border-m2p-border p-6">
              <h2 className="text-lg font-bold text-m2p-ink mb-3">Amazon book description (KDP-ready HTML)</h2>
            ...
            <div className="rounded-2xl bg-m2p-orange-soft/50 border border-m2p-border p-6">
              <h2 className="text-lg font-bold text-m2p-ink mb-3">Author bio template</h2>
              <p className="text-m2p-ink text-sm leading-relaxed whitespace-pre-wrap">{result.authorBioTemplate}</p>
            </div>
            <div className="rounded-2xl bg-m2p-orange-soft/50 border border-m2p-border p-6">
              <h2 className="text-lg font-bold text-m2p-ink mb-3">7 SEO keywords</h2>
              <ul className="flex flex-wrap gap-2">
                {result.seoKeywords.map((kw, i) => (
                  <li key={i} className="rounded-lg bg-red-900/30 border border-red-700/40 px-3 py-1.5 text-sm text-m2p-ink">{kw}</li>
                ))}
              </ul>
            </div>
            <div className="rounded-2xl bg-m2p-orange-soft/50 border border-m2p-border p-6">
              <h2 className="text-lg font-bold text-m2p-ink mb-3">2 recommended BISAC categories</h2>
