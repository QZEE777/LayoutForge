    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <main className="mx-auto max-w-2xl px-6 py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-slate-500 text-sm">If you design in Canva and export PDF, that PDF is your interior — use <Link href="/kdp-pdf-checker" className="text-green-400 hover:text-green-300 underline">KDP Preflight</Link> to verify. This formatter is for the Word/manuscript path.</p>
        </div>
