  ...
  return (
    <div className="min-h-screen bg-ivory px-6 py-16">
      <div className="mx-auto max-w-2xl">
        ...
        <h1 className="font-bebas text-3xl text-amazon-navy mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-sm max-w-none text-amazon-navy space-y-8">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">1. Who we are</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">2. What we collect</h2>
            <ul className="list-disc pl-5 text-soft-muted space-y-1">
              ...
              <li><strong>Usage and technical data:</strong> Log data (e.g. IP address, browser type), pages visited, and tool usage to operate the site, prevent abuse, and improve our services. We may use cookies and similar technologies as described in our <Link href="/cookies" className="text-brave hover:underline">Cookie Policy</Link>.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">3. Why we use your data</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">4. Retention</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">5. We do not sell your data</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">6. Sharing and third parties</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">7. Cookies and similar technologies</h2>
            <p className="text-soft-muted">
              We use cookies and similar technologies for essential operation (e.g. sign-in), and may use them for analytics or preferences. Details are in our <Link href="/cookies" className="text-brave hover:underline">Cookie Policy</Link>. Where required by law, we obtain consent for non-essential cookies.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">8. Security</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">9. Your rights</h2>
            <p className="text-soft-muted">
              Depending on where you live, you may have the right to: access, correct, or delete your personal data; restrict or object to processing; data portability; and withdraw consent. In the EU/EEA and UK, you may lodge a complaint with a supervisory authority. To exercise your rights, contact us via <Link href="/contact" className="text-brave hover:underline">Contact</Link>. We will respond within the timeframes required by applicable law.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">10. International transfers</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">11. Children</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">12. Changes</h2>
            <p className="text-soft-muted">
          ...
          <section>
            <h2 className="text-lg font-semibold text-amazon-navy mt-6 mb-2">13. Contact</h2>
            <p className="text-soft-muted">
              For privacy-related questions or to exercise your rights, contact us via <Link href="/contact" className="text-brave hover:underline">Contact</Link> or the email address listed there.
            </p>
          </section>
        </div>
      </div>
