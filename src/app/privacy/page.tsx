    ...
    <SiteShell>
      <section className="bg-[#FAF7EE] py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="prose prose-sm max-w-none space-y-8 [&_h2]:text-[#1A1208] [&_h2]:font-semibold [&_p]:text-[#6B6151] [&_ul]:text-[#6B6151] [&_a]:text-[#F05A28] [&_a]:hover:underline" style={{ fontFamily: "Inter, sans-serif" }}>
          <section>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">1. Who we are</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">2. What we collect</h2>
            <ul className="list-disc pl-5 text-[#6B6151] space-y-1">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">3. Why we use your data</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">4. Retention</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">5. We do not sell your data</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">6. Sharing and third parties</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">7. Cookies and similar technologies</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">8. Security</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">9. Your rights</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">10. International transfers</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">11. Children</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">12. Changes</h2>
            <p className="text-[#6B6151]">
          ...
          <section>
            <h2 className="text-lg font-semibold mt-6 mb-2 text-[#1A1208]">13. Contact</h2>
            <p className="text-[#6B6151]">
