      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
          ...
          <div className="mb-8 bg-[#24241a] border border-white/10 rounded-lg p-6">
            ...
            <ul className="text-sm text-[#8B8B6B] space-y-1">
              {report.outputType === "checker" ? (
                ...
                <>
                  {report.wordCount != null && <li>Word count: <span className="text-[#F5F0E8]">{report.wordCount.toLocaleString()}</span></li>}
                  {report.estimatedPages != null && <li>Est. pages (6×9): <span className="text-[#F5F0E8]">~{report.estimatedPages}</span></li>}
                  {report.recommendedGutterInches != null && <li>Recommended gutter: <span className="text-[#F5F0E8]">{report.recommendedGutterInches}&quot;</span></li>}
                </>
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#8B8B6B]">
            {isFormatReview
              ? "Review the report above and download the .txt for your records."
              : isChecker
        ...
        <div className="mt-8 bg-[#24241a]/50 border border-white/10 rounded-lg p-4 space-y-2">
          <p>
            ...
            <span className="text-xs text-[#8B8B6B]">
              {isChecker || isFormatReview ? "Your report is stored temporarily for 24 hours." : "Your files are stored temporarily for 24 hours. Download now and keep a backup."}
            </span>
          </p>
